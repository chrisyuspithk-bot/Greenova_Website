# 8e01ccc5-af46-4515-90f7-5bb125851a1a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `greenova-landing-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `greenova-landing-v2.html`
...
- A single self-contained `greenova-landing-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `greenova-landing-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `greenova-landing-v2.html`
- `greenova-landing.html`
...
1. Inspect `greenova-landing-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
